...
import { ObjectListItem } from '@/features/objects/components/objectListItem';
...
import type { MaskMetadata, SegmentationResponse } from '@/features/segmentation/store/segmentationStore';
