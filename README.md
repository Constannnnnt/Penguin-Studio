...
The system is developed and tested on Windows 11 with RTX 3070.
...
An example `BRIA_API_KEY` can be found in this [doc](). Please copy this key and paste it in a new `.env` file in the `backend` folder.
